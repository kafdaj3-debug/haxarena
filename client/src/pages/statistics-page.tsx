...
export default function StatisticsPage() {
  ...
  // Get top 50 sorted by active category
  const getSortedTop50 = (category: SortCategory) => {
  ...
  const top50Players = getSortedTop50(activeCategory);
      ...
      <main className="flex-1 bg-background">
        <div className="max-w-7xl mx-auto px-4 py-8 space-y-8">
          ...
          <div>
            ...
            {/* TOP 50 Table - renders based on active category */}
